            ...
            <div class="card-header">
                ...
                <div class="card-search">
                    <el-row :gutter="10" justify="end">
                        <el-col :span="12">
                            <el-input :prefix-icon="Search" v-model="userId" @keyup.enter="validateAndSearch"
                                placeholder="请输入用户ID" />
                        </el-col>
                        <el-col :span="7.5">
        ...
        <div class="table-box" v-if="showTable">
            <el-table element-loading-text="数据加载中..." v-loading="loading" :data="tableData"
                ...
                <el-table-column label="操作">
                    <template #default="scope">
                        <el-button size="small" style="margin: 0 0 10px 10px;"
                            @click="authModify(scope.row)">修改</el-button>
                    </template>
                </el-table-column>
            </el-table>
